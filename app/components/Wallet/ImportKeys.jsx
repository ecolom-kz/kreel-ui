...
import {PrivateKey, Aes, PublicKey, FetchChain, hash} from "kreeljs";
...
class ImportKeys extends Component {
    ...
    /** KREEL 1.0 client wallet_export_keys format. */
    _parseImportKeyUpload(json_contents, file_name, update_state) {
        ...
        // KREEL 1.0 wallets may have a lot of generated but unused keys or spent TITAN addresses making
        // wallets so large it is was not possible to use the JavaScript wallets with them.
    }

    /**
     KREEL 1.0 hosted wallet backup (wallet.bitshares.org) is supported.

     KREEL 1.0 native wallets should use wallet_export_keys instead of a wallet backup.
    ...
    _parseWalletJson(json_contents) {
        ...
        let savePubkeyAccount = function(pubkey, account_name) {
            ...
            address = "KREEL" + address.substring(3);
        ...
        try {
            ...
            if (!encrypted_brainkey)
                throw "Please use a KREEL 1.0 wallet_export_keys file instead";
